...
public class ArchivoCampanaListaCanal {
	...
	public void archivarCampannasListasCanales(List<CampannaListaCanal> clc) {
		...
		outFileDat = "C:/apps/eilcis_sieb_mktcampanalistacanal."+formateador.format(now)+".dat";
		outFileCif = "C:/apps/eilcis_sieb_mktcampanalistacanal."+formateador.format(now)+".cif";
