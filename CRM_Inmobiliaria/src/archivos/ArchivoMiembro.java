...
public class ArchivoMiembro {
	...
	public void archivarMiembros(List<Miembro> mem){
		outFileDat = "C:/apps/eilcis_sieb_miembro."+formateador.format(now)+".dat";
		outFileCif = "C:/apps/eilcis_sieb_miembro."+formateador.format(now)+".cif";
        ...
        try{
        	...
        	for(Miembro cat : mem){
        		...
        		salidaDat.write(cat.getCentroComercial());
