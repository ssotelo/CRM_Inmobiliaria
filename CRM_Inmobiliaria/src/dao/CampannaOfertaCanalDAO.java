...
public class CampannaOfertaCanalDAO {
	...
	private String SELECT_CATGEN = "SELECT TOF.ROW_ID, TT.ROW_ID, TC.ROW_ID, TOF.APPR_STAT_CD,"
			+ "	TT.COST, TO_CHAR(TT.START_DT,'YYYYMMDD')START_DT, TO_CHAR(TT.END_DT,'YYYYMMDD')END_DT,"
			+ " TO_CHAR(TC.LAST_UPD,'YYYYMMDD')LAST_UPD, TT.X_ID_TREAT, TT.NAME FROM SIEBEL811.S_SRC TC,"
			+ " SIEBEL811.S_MKTG_OFFR TOF, SIEBEL811.S_SRC_DCP TRT, SIEBEL811.S_DMND_CRTN_PRG TT WHERE TRT.SRC_ID=TC.ROW_ID(+) "
