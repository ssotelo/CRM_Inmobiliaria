...
public class CampannaOfertaDAO {
	...
	private String SELECT_CATGEN = "SELECT TC.ROW_ID, TOF.ROW_ID, TOF.X_ATTRIB_05, "
			...
			+ "TO_CHAR(TR.LAST_UPD,'YYYYMMDD')LAST_UPD,TT.X_ID_TREAT, TT.NAME "
			+ "FROM SIEBEL811.S_SRC TC, SIEBEL811.S_SRC_DCP TR, SIEBEL811.S_MKTG_OFFR TOF, "
